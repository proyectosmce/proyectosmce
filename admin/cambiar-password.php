        ...
        <div id="sidebar" class="fixed md:static inset-y-0 left-0 w-64 bg-white shadow-lg transform -translate-x-full md:translate-x-0 transition-transform duration-200 z-40">
            ...
            <nav class="p-4">
                <ul class="space-y-2">
                    ...
                    <li><a href="cambiar-password.php" class="flex items-center space-x-2 p-2 bg-blue-50 text-blue-600 rounded"><i class="fas fa-lock"></i><span>Cambiar clave</span></a></li>
