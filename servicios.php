...
<section class="max-w-7xl mx-auto px-4 py-16">
    ...
    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div class="group bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl shadow-soft hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 relative overflow-hidden animate-on-scroll p-8 text-white">
            ...
            <!-- Precio y CTA en USD -->
            <div class="flex flex-col mb-4 bg-white/5 p-3 rounded-lg border border-white/5">
                <?php
                $usdPrice = "Consultar";
                ...
                <div class="flex flex-wrap items-baseline gap-2">
                    <span class="text-xs uppercase tracking-wider text-white/80 font-bold i18n-srv-from" data-i18n="srv-from">Desde</span>
                    <span class="text-3xl font-extrabold text-brand-accent tracking-tighter">
                        <span class="text-lg mr-1">USD</span>$<?php echo $usdPrice; ?>
                    </span>
                </div>
            </div>
