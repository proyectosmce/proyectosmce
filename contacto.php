...
<section id="form-feedback" class="max-w-7xl mx-auto px-4 mt-8">
    ...
    <?php if (isset($_GET['error'])): ?>
        <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded mb-6">
            <?php if ($_GET['error'] == 4): ?>
                <span class="i18n-ct-error-4" data-i18n="ct-error-4">El formulario se guardó, pero falta configurar el correo del sitio. Inténtalol más tarde.</span>
        ...
        <div class="lg:col-span-7 order-2 lg:order-1">
            <form id="contact-form" action="enviar-contacto.php" method="POST" class="bg-white p-8 rounded-2xl mce-rounded-panel shadow-2xl border border-slate-100 overflow-hidden space-y-6">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    ...
                    <button type="submit" id="contact-submit" <?php echo $contactRecaptchaEnabled ? '' : 'disabled'; ?> class="cta-primary inline-flex items-center justify-center px-6 py-3 rounded-xl font-semibold shadow-lg transition w-full sm:w-auto disabled:cursor-not-allowed disabled:bg-slate-400">
...
(() => {
    ...
    applyTemplate(lang);
    window.addEventListener('mce-lang-changed', (e) => applyTemplate(e.detail?.lang || 'es'));
})();
</script>
